...
Calendar.prototype = {constructor: Calendar, back: function back(func) {
        var date = this.date;
...
Calendar.prototype.draw = function () {
    ...
    for (var i = 0; i < theContainers.length; i += 1) {
...
Calendar.prototype.update = function () {
    ...
    for (var i = 0, j = previousLastDay; i < firstDayLabelPos; i += 1, j -= 1) {
    ...
    for (var i = 1; i <= lastDay; i += 1) {
        ...
        if (this.date.getMonth() == this.today.getMonth()) {
            if (i == this.today.getDate()) {
                document.getElementById(this.id + '-day-' + (firstDayLabelPos + i)).className += " cjslib-day-today"
            }
        }
    }
    for (var i = lastDay + 1, j = 1; firstDayLabelPos + i <= 42; i += 1, j += 1) {
        document.getElementById(this.id + '-day-num-' + (firstDayLabelPos + i)).innerHTML = j;
        document.getElementById(this.id + '-day-' + (firstDayLabelPos + i)).className = this.id + " cjslib-day cjslib-day-diluted"
    }
};
...
Organizer.prototype = {constructor: Organizer, back: function back(func) {
        ...
        window.setTimeout(function () {
            if (document.getElementById(calendarInstance.id + "-day-num-" + blockId).innerHTML.length > 0) {
                if (document.getElementById(calendarInstance.id + "-day-num-" + blockId).dataset.longpressed == "false") {
                    ...
                    document.getElementById(calendarInstance.id + "-day-num-" + blockId).dataset.longpressed = true
                }
                if (document.getElementById(calendarInstance.id + "-day-radio-" + blockId).checked) {
                    return
                }
